...
Pod::Spec.new do |s|
  s.name             = 'LeagueAPI'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LeagueAPI.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/LeagueAPI'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mason Phillips' => 'math.matrix.tumblr@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/LeagueAPI.git', :tag => s.version.to_s }
